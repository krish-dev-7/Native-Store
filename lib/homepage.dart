...
String email, item, custEmail, custUName, custNumber, custName;
int itemCount;
double lat, long;
                            ...
                            Padding(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  setState(() {
                                    email =
                                        userDocument.documents[index]['email'];
                                  });
                                  showModalBottomSheet<void>(
                                      context: context,
                                      builder: (BuildContext context) {
                                                                ...
                                                                onPressed:
                                                                  ...
                                                                  showDialog<
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return AlertDialog(
                                                                        title: Text(
                                                                            '${userDocument.documents[index]['Shop Type']}'),
                                                                        content:
                                                                            SingleChildScrollView(
                                                                          child:
                                                                              ListBody(
                                  ...
                                  child: Center(
                                    child: Text(
                                      userDocument.documents[index]
                                          ['Shop Name'],
                                      style: TextStyle(color: pc, fontSize: 30),
                                    ),
                                  ),
                                ),
                              ),
